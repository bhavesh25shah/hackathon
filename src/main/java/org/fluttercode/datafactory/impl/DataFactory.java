...
public final class DataFactory {
	 ...
	 *            List of items to choose from
	 * @param probability
	 *            chance (in %, 100 being guaranteed) of returning an item from the
	 *            list
	...
	/**
	 * Returns a random item from a list of items or the defaultItem depending on
	 * the probability parameter. The probability determines the chance (in %) of
	 * returning an item off the list versus the default value.
	 *
	 * @param <T>
	 *            Item type in the list and to return
	 * @param items
	...
	/**
	 * Returns a random item from an array of items or the defaultItem depending on
	 * the probability parameter. The probability determines the chance (in %) of
	 * returning an item from the array versus the default value.
	 *
	 * @param <T>
	 *            Array item type and the type to return
	 * @param items
	...
	/**
	 * Generates an address value consisting of house number, street name and street
	 * suffix. i.e. <code>543 Larkhill Road</code>
	 *
	...
	/**
	 * Generates line 2 for a street address (usually an Apt. or Suite #). Returns
	 * null if the probabilty test fails.
	 *
	 * @param probability
	...
	/**
	 * Generates line 2 for a street address (usually an Apt. or Suite #). Returns
	 * default value if the probabilty test fails.
	 *
	 * @param probability
	 *            Chance as % of have a value returned instead of null.
	 * @param defaultValue
	...
	public String getBirthDate() {
		...
		return sdf.format(getDate(base, -365 * 15, 365 * 15));
	}
	...
	public double getDecimalNumberBetween(final BigDecimal min, final BigDecimal max) {
		...
		return new BigDecimal(min.doubleValue() + (random * (max.doubleValue() - min.doubleValue())))
	 ...
	 * <code>maxDaysFromData</code>. This method does not alter the time component
	 * and the time is set to the time value of the base date.
	 *
	 * @param baseDate
	 *            Date to start from
	 ...
	 */
	public String getDateBetween(final Date minDate, final Date maxDate) {
	 ...
	 *
	 * @param minLength
	 *            minimum number of characters to use in the string
	 * @param maxLength
	 *            maximum number of characters to use in the string
	 *
	 * @return A string containing <code>length</code> random characters
	 */
	...
	/**
	 * Returns a valid word with a length of up to <code>length</code> characters.
	 * If the <code>exactLength</code> parameter is set, then the word will be
	 * exactly <code>length</code> characters in length.
	 *
	 * @param length
	 *            maximum length of the returned string
	 * @param exactLength
	 *            indicates if the word should have a length of <code>length</code>
	...
	/**
	 * Gives you a true/false based on a probability with a random number generator.
	 * Can be used to optionally add elements.
	 *
	 * <pre>
	 ...
	 * @return true or false value based on the random number generated and the
	 *         chance value passed in
	 */
	...
	/**
	 * Set this to provide your own list of name data values by passing it a class
	 * that implements the {@link NameDataValues} interface which just returns the
	 * String arrays to use for the test data.
	 *
